...
//==============================================================================
void Transform::transform_1_to_2(double x, double y, double& out_x, double& out_y)
{
  _pimpl->transform_1_to_2(x, y, out_x, out_y);
}

//==============================================================================
void Transform::transform_2_to_1(double x, double y, double& out_x, double& out_y)
{
